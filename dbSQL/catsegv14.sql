...
(24, 1, 'studentfirstname1', 'studentlastname1', 'student1', 'student1', 'dummy.jpg', '×.tâé«04¸ŠÚ®oõ	', 6, 'F', '2020-10-02 13:41:02', 0),
...
(4, 1, 'Theodoric', 'Theo', 'mrtheo', '3_1599974146.jpg', 'kO“7[»ì%~ñ:c{', 0),
(5, 1, 'teacherF', 'teacherL', 'teacher1', '3_1599974146.jpg', 'fñ`¡Â7äZOäS•¡', 0);
...
INSERT INTO `who_lost_roger` (`recordid`, `studentid`, `score`, `level`, `percentage`, `timeUsed`, `nounsClicked`, `status`) VALUES
(7, 0, 11, 1, 100, '22', 'asda|asa|asa', 0),
(8, 24, 15, 1, 100, '', '', 0);
