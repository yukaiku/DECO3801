...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2020 at 06:48 AM
...
INSERT INTO `friendship` (`user`, `friend`, `status`) VALUES
(1, 3, 0),
(1, 5, 0),
(1, 7, 0);
...
INSERT INTO `student` (`id`, `school`, `firstname`, `lastname`, `username`, `nickname`, `profileImage`, `pwd`, `grade`, `class`, `status`) VALUES
(1, 1, 'German', 'Shephard', 'cleverpuppy', 'puppy', '', 'GS1234', 5, 'E', 0),
...
(19, 1, 'theo', 'theo', 'theo', 'theo', '', 'z³Œøç¿÷êl#Wø', 6, 'E', 0);
...
--
ALTER TABLE `friendship`
  ADD CONSTRAINT `fk_friend` FOREIGN KEY (`friend`) REFERENCES `student` (`id`),
  ADD CONSTRAINT `fk_user` FOREIGN KEY (`user`) REFERENCES `student` (`id`);
